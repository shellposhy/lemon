 ...
 * @version 1.0
 */
@XStreamAlias("UserResult")
public class DomUserResultBody implements Serializable {
	 ...
	 */
	public static String generator(DomUserResultBody data, boolean isUseCDATA, boolean isContainHeader) {
		return Xmls.generator(data, isUseCDATA, isContainHeader, DomUserResultBody.class);
	}
